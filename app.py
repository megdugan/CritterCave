...
def about():
    ...
    if 'uid' not in session:
        ...
        return redirect(url_for('signin'))
    try:
        return render_template('about.html', page_title='About CritterCave')
    except Exception as e:
        print(e)
        uid=session['uid']
        flash('An error occurred. Please try again.')
...
def create():
    ...
    if 'uid' not in session:
        ...
        return redirect(url_for('signin'))
    try:
        return render_template('create.html', page_title='Create a Critter')
    except Exception as e:
        print(e)
        uid=session['uid']
        flash('An error occurred. Please try again.')
...
def story_page(cid, sid):
    ...
    try:
        ...
        print(story_info)
        print(critter_info)
        return render_template('story.html', story_info=story_info, critter_info=critter_info, page_title='Story Page')
    except Exception as e:
        print(e)
        flash('An error occurred. Please try again.')
        return redirect(url_for('user_profile', uid=uid))
    ...
    try:
        ...
        if request.method == 'GET':
            ...
            try:
                ...
                print(e)
                flash('An error occurred. Please try again.')
                return redirect(url_for('delete_critter', cid=cid))
    except Exception as e:
        print(e)
        flash('An error occurred. Please try again.')
        return redirect(url_for('user_profile', uid=uid))
...
def delete_story(sid):
    ...
    try:
        ...
        if story_info['uid'] != uid:
            ...
            return redirect(url_for('story_page', sid=sid, cid=story_info['cid']))
        ...
        if request.method == 'GET':
            ...
            try:
                ...
                print(e)
                flash('An error occurred. Please try again.')
                return redirect(url_for('delete_story', sid=sid))
    except Exception as e:
        print(e)
        flash('An error occurred. Please try again.')
        return redirect(url_for('user_profile', uid=uid))
...
def edit_story(sid):
    ...
    try:
        ...
        if story_info['uid'] != uid:
            flash('A story can only be edited by its creator')
